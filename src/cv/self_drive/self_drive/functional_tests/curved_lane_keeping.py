...
class CurvedLanekeeping(FunctionalTest):
    ...
    def state_machine(self):
        ...
        for contour in cnts:
            for point in contour:
                ...
                valid_left_point = x < left_max and x > left_min and y > vert_min and y < vert_max
    ...
    def show_search_boxes(self, color: int) -> None:
        ...
        cv2.line(self.final_mask, (left_min, vert_min), (left_min, vert_max), color, 10)
        cv2.line(self.final_mask, (left_max, vert_min), (left_max, vert_max), color, 10)
        cv2.line(self.final_mask, (left_min, vert_min), (left_max, vert_min), color, 10)
        cv2.line(self.final_mask, (left_min, vert_max), (left_max, vert_max), color, 10)

        cv2.line(self.final_mask, (right_min, vert_min), (right_min, vert_max), color, 10)
        cv2.line(self.final_mask, (right_max, vert_min), (right_max, vert_max), color, 10)
