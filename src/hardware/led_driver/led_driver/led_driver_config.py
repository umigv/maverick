...
class LedDriverConfig:
    ...
    Attributes:
        estop_file_path: Path to the file containing the e-stop state ("1" = stopped). Wired by hardware.launch.py so
            all e-stop readers and writers share the same file.
