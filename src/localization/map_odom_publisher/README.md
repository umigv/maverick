...
| ------------------ | ------- | ------------------------------------------------------------------------- |
| `map_frame_id`     | -       | Expected `frame_id` of `odom` and parent of the broadcasted TF (required) |
| `odom_frame_id`    | -       | Child frame of the broadcasted TF; used for TF lookup (required)          |
| `base_frame_id`    | -       | Expected `child_frame_id` of `odom`; used for TF lookup (required)        |
